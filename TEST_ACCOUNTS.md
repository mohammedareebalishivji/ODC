...
All three are **verified** (badge on). Workers log in as **available** by default.

## Admin

| Role  | Email                     | Password        | Login                                  |
| ----- | ------------------------- | --------------- | -------------------------------------- |
| Admin | admin@odc-internal.com    | OdcAdmin!2026   | punched-in TOTP code (printed at boot) |

## Demo accounts (original)

| Role    | Email              | Password    | Phone          |
| ------- | ------------------ | ----------- | -------------- |
| Manager | priya@odc.in       | Bistro!2026 | +91 00000 00001 |
| Chef    | arjun@odc.in       | Culinary!2026 | +91 00000 00002 |
| Chef    | lena@odc.in       | Culinary!2026 | +91 00000 00003 |
| Waiter  | ravi@odc.in       | Waiter!2026  | +91 00000 00004 |
